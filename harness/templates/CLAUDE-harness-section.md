...
- **Retired claims leave the live board** (`ledger/librarian`): a defeated or superseded claim moves to `ledger/trace/` with a pointer, retired in the same commit (immutability discipline).
