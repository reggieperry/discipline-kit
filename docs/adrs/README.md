...
| [ADR-0005](ADR-0005-containment-posture.md) | The containment posture—the fence is friction, isolation is the precondition for unattended work | Accepted | INSTALL-HARDENING.md written; the unattended-start gate (D2) future; per-decision courts named | None | 2026-08-15 |
