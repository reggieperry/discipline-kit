...
- **Project-specific glob** (e.g., `paths: ["billing/**", "agents/scan_stage.py"]`) — the rule is project content. Project-specific examples are appropriate. The overlay home is `.claude/rules/project/`; the rule itself was never portable.
