...
**Enforcement grade:** review and convention until FindSecBugs is wired on the gate's SpotBugs engine (pending a compiled pilot, since SpotBugs analyzes bytecode); the gate does not yet police this file's topics mechanically. Checkstyle, the wired Java Check-A scanner, is a style tool, not a security one.
