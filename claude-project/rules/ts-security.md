...
**Enforcement grade:** review and convention until a TypeScript security toolchain is wired (`eslint-plugin-security` or `semgrep`); the gate does not yet police this file's topics mechanically.
