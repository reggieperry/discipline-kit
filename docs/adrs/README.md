...
| [ADR-0004](ADR-0004-substrate-choice.md) | Each phase is its own headless invocation, and the sequencer owns the worktrees | Proposed | courts future, named per decision; the probe record is the standing observation | None | 2026-08-12 |
